...
export function OnboardingFlow() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
          ...
          <div className="w-full px-6">
            <div className="flex flex-col items-center text-center animate-in fade-in duration-500">
              ...
              <p className="font-['Poppins'] text-[15px] text-gray-500 mb-8 max-w-[360px] leading-relaxed">
                Follow curated trails by local creators. Unlock stops, earn
                points, and share your journey with the community.
              </p>
        ...
        <div className="flex-1 flex flex-col animate-in fade-in duration-500">
          ...
          <div className="flex-1 px-6 -mt-4 relative z-10 overflow-y-auto pb-6">
            ...
            <div className="flex gap-3 mb-5">
              <button
                onClick={() =>
                  handleSocialLogin("google-user@gmail.com", "google123")
                }
                disabled={authLoading}
              ...
              <button
                onClick={() =>
                  handleSocialLogin("apple-user@icloud.com", "apple123")
                }
                disabled={authLoading}
                className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition-colors"
              >
              ...
              <>
                ...
                {otpVerifying && (
                  <div className="flex items-center justify-center gap-2 mb-4">
                    ...
                    <p className="font-['Poppins'] text-[14px] text-blue-600">
                      Verifying...
                    </p>
                  </div>
                )}
      ...
      {step === 3 && (
        <div className="flex-1 px-6 pt-6 animate-in fade-in duration-500 overflow-y-auto pb-6">
          <button
            onClick={() => {
              if (user.isLoggedIn && user.emailVerified) setStep(2);
              else setStep(1);
            }}
              ...
              <div className="mt-3 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50 border border-purple-100 rounded-2xl p-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <div className="bg-white/70 rounded-xl px-2 py-2 text-center">
                    <ImageIcon
                      size={14}
                      className="text-pink-500 mx-auto mb-1"
                    />
                    <p className="font-['Poppins'] text-[14px] font-semibold text-gray-900">
          ...
          <div className="space-y-4 mb-8">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={
                  igProfile?.bio || "Trail lover, foodie, explorer..."
                }
                rows={2}
          ...
          {igProfile && (
            <div className="flex items-center gap-2 mb-4 px-4 py-2.5 rounded-xl bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-100">
              ...
              <p className="font-['Poppins'] text-[12px] text-gray-600">
                Connected as{" "}
                <span className="font-semibold">@{igProfile.username}</span> ·{" "}
